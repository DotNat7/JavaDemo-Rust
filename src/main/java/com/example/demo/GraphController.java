...
public class GraphController {
    ...
    public void initialize() {
        ...
        //chlapci
        addPercentileSeries("P3", new double[][]{{0.0, 11.4},{0.2, 12.4},{0.4, 13.4},{0.6, 14.0}, {0.8, 14.4}, {1.0, 14.5}, {1.2, 14.5}, {1.4, 14.3}, {1.6, 14.2}, {1.8, 14.0}, {2.0, 13.9}, {2.2, 13.7}, {2.4, 13.7}, {2.6, 13.6}, {2.8, 13.5}, {3.0, 13.5}, {3.5, 13.4}, {4.0, 13.3}, {4.5, 13.2}, {5.0, 13.1}, {5.5, 13.0}, {6.0, 13.1}, {7.0, 13.1},
{8.0, 13.2}, {9.0, 13.5}, {10.0, 13.7}, {11.0, 14.1}, {12.0, 14.5}, {13.0, 15.0}, {14.0, 15.7}, {15.0, 16.4}, {16.0, 17.1}, {17.0, 17.6}, {18.0, 18.2},});
